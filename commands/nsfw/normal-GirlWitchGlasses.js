...
module.exports = {
    name: "GirlWitchGlases",
    aliases: ["GirlWitchglases", "Girlwitchglases", "girlwitchglases", "gwg"],
            ...
            try {
                async function getImage() {
                    ...
                    if (link.includes('redgifs')
                        ...
                        let Nsfw_embed = {
                            title: `${client.emotes.NSFW1}| Girl witch glasses || ${Responses[Response]}`,
                            fields: [
                                {
                                    name: 'Tytuł:',
                                    value: title,
                    ...
                    let Nsfw_embed = new MessageEmbed()
                        ...
                        .setURL(link)
                        .setTitle(`${client.emotes.NSFW1}| Girl witch glasses || ${Responses[Response]}`)
