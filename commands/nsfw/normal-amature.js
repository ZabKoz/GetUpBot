            ...
            try {
                async function getImage() {
                    ...
                    if (link.includes('redgifs')
                        ...
                        let Nsfw_embed = {
                            title: `${client.emotes.NSFW1}| Amature || ${Responses[Response]}`,
                            fields: [
                                {
                                    name: 'Tytuł:',
                                    value: title,
                    ...
                    let Nsfw_embed = new MessageEmbed()
                        ...
                        .setURL(link)
                        .setTitle(`${client.emotes.NSFW1}| Amature || ${Responses[Response]}`)
                        ...
                        embedMessage.react(client.emotes.boobs1)
                        .then(() => embedMessage.react(client.emotes.client.emotes.boobs2))
                        .then(() => embedMessage.react(client.emotes.client.emotes.assclap1))
                        .then(() => embedMessage.react(client.emotes.client.emotes.slapAss2))
                        .then(() => embedMessage.react(client.emotes.client.emotes.NoGodNo))
                    })
                }
                getImage();
            } catch (err) {
