...
module.exports = {
    name: "HPokémon",
    aliases: ["hpokémon", "HPokemon", "hpokemon", "Hpokemon"],
                ...
                async function getImage() {
                    ...
                    if (link.includes('redgifs')
                        ...
                        || link.includes('gallery')) {
                            let Nsfw_embed = {
                                title: `${client.emotes.NSFW1}| Hentai Pokémon || ${Responses[Response]}`,
                                fields: [
                                    {
                                        name: 'Tytuł:',
                                        value: title,
                    ...
                    let Nsfw_embed = new MessageEmbed()
                        ...
                        .setURL(link)
                        .setTitle(`${client.emotes.NSFW1}| Hentai Pokémon || ${Responses[Response]}`)
