            ...
            try {
                async function getImage() {
                    ...
                    if (link.includes('redgifs')
                        ...
                        let Nsfw_embed = {
                            title: `${client.emotes.NSFW1}| Boobs Fuck || ${Responses[Response]}`,
                            fields: [
                                {
                                    name: 'Tytuł:',
                                    value: title,
                        ...
                        message.channel.send(link).then(embedMessage => {
                            ...
                            .then(() => embedMessage.react(client.emotes.boobs3))
                            .then(() => embedMessage.react(client.emotes.boobs4))
                    ...
                    let Nsfw_embed = new MessageEmbed()
                        .setColor(embedNsfw)
                        .setURL(link)
                        .setTitle(`${client.emotes.NSFW1}| Boobs Fuck || ${Responses[Response]}`)
