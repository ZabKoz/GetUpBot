...
module.exports = {
    name: "HStarWars",
    aliases: ["HStarwars", "Hstarwars", "hstarwars"],
                ...
                async function getImage() {
                    ...
                    if (link.includes('redgifs')
                        ...
                        || link.includes('gallery')) {
                            let Nsfw_embed = {
                                title: `${client.emotes.NSFW1}| Hentai StarWars || ${Responses[Response]}`,
                                fields: [
                                    {
                                        name: 'Tytuł:',
                                        value: title,
                    ...
                    let Nsfw_embed = new MessageEmbed()
                        ...
                        .setURL(link)
                        .setTitle(`${client.emotes.NSFW1}| Hentai Starwars || ${Responses[Response]}`)
